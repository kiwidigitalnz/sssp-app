              ...
              <li key={step.name} className="relative">
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    >
                      {status === "completed" ? (
                        <div className="flex h-5 w-5 items-center justify-center rounded-full bg-primary cursor-pointer hover:bg-primary/80 transition-colors">
                          <svg
                        ...
                        <div
                          className="flex h-5 w-5 items-center justify-center rounded-full border-2 border-primary cursor-pointer"
                          aria-current="step"
                        >
                          <span
                        ...
                        <div className="flex h-5 w-5 items-center justify-center rounded-full border-2 border-gray-300 cursor-pointer hover:border-gray-400 transition-colors">
                          <span
